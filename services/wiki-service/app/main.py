"""wiki-service — FastAPI entrypoint.

Wiki pages, versions, cross-references, visibility and DM approval. All
permission enforcement for content lives here: every query is scoped by
campaign_id and filtered by the caller's role (campaign-service membership).
Publishes wiki.published / wiki.updated / wiki.archived / wiki.draft_ready.
"""
...
from app.api import internal, pages, timeline
...
app = FastAPI(title="wiki-service", version="0.2.0", lifespan=lifespan)
