"""RabbitMQ event publisher for session-service.

Uses a single robust connection for the process lifetime (FastAPI lifespan)
and reuses dnd_common.events for the envelope + topic topology. session-service
only publishes; workers update state via the internal HTTP endpoints.
"""
