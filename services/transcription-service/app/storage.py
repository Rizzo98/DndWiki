...
The worker downloads the recording to a staging file and uploads the
transcript/diarization JSON documents; all URLs handed to clients are
short-lived presigned ones generated by session-service instead.
"""
