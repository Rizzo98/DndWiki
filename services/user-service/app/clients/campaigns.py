...
user-service never reads dnd_campaigns tables directly; before enrolling a
voiceprint it asks campaign-service GET /internal/membership with a service
token (same client as session-service).
"""
